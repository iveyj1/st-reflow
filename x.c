...
xloadalpha(void)
{
	float opacity = focused ? alpha : alphaUnfocused;

	dc.col[defaultbg].color.alpha = (unsigned short)(0xffff * opacity);
	dc.col[defaultbg].pixel &= 0x00FFFFFF;
	dc.col[defaultbg].pixel |= (unsigned char)(0xff * opacity) << 24;
}
...
usage(void)
{
	die("usage: %s [-A alpha] [-aiv] [-c class] [-f font] [-g geometry]"
	    " [-n name] [-o file]\n"
	    "          [-T title] [-t title] [-w windowid]"
	    " [[-e] command [args ...]]\n"
	    "       %s [-A alpha] [-aiv] [-c class] [-f font] [-g geometry]"
	    " [-n name] [-o file]\n"
